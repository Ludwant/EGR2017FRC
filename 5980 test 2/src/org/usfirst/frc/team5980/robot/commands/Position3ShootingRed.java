 ...
 *
 */
public class Position3ShootingRed extends CommandGroup {

    public Position3ShootingRed() {
        // Add Commands here:
    	...
    	addSequential(new RotateToHeadingCommand(-140, 0.3));
    	addSequential(new DriveForwardAutoCommand(.7, 103, -140));
    }
}
